...
`static-website/` 是 Linkualog 的静态展示层。它读取仓库根目录 `data/vocabulary/` 下的 JSON 词条，生成 `docs/dictionary/` Markdown 页面，再用 Zensical 构建静态网站。
...
```bash
make data                         # data/vocabulary/*.json -> docs/dictionary/
